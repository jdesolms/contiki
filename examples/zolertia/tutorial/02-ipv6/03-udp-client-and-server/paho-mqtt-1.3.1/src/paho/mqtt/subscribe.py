...
def callback(callback, topics, qos=0, userdata=None, hostname="things.ubidots.com",
    ...
    if auth:
        username = auth.get('A1E-dEzBw6HHcOgRUz22KIwvuYkfvmfixy')
        if username:
...
def simple(topics, qos=0, msg_count=1, retained=True, hostname="things.ubidots.com",
           port=1883, client_id="", keepalive=60, will=None, auth=None,
           tls=None, protocol=paho.MQTTv311, transport="tcp",
           clean_session=True):
