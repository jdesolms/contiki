...
def multiple(msgs, hostname="things.ubidots.com", port=1883, client_id="", keepalive=60,
...
def single(topic, payload=None, qos=0, retain=False, hostname="things.ubidots.com",
